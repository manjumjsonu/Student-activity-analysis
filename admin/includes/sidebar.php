...
{               ?>
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="ui-basic1">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="add-lectures.php">Add lecture</a></li>
                  <li class="nav-item"> <a class="nav-link" href="manage-lectures.php">Manage lecture</a></li>
                  </ul>
              </div>
                <li class="nav-item">
              <a class="nav-link" data-toggle="collapse" href="#ui-basic1" aria-expanded="false" aria-controls="ui-basic1">
                <span class="menu-title">Allocate</span>
                <i class="icon-people menu-icon"></i>
              </a>
                <div class="collapse" id="ui-basic1">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="Allocate.php">Allocate</a></li>
                  <li class="nav-item"> <a class="nav-link" href="manage-allocate.php">Manage Allocate</a></li>
                  </ul>
              </div>
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="ui-basic1">
                <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item"> <a class="nav-link" href="manage-subjects.php">Manage Subject</a></li>
                </ul>
              </div>
