...
$newpassword=md5($_POST['newpassword']);
  $sql ="SELECT LectureEmail FROM tbllecture WHERE LectureEmail=:email and ContactNumber=:mobile";
...
if($query -> rowCount() > 0)
{
$con="update tbllecture set Password=:newpassword where LectureEmail=:email and ContactNumberNumber=:mobile";
...
echo "<script>alert('LectureEmail id or ContactNumber no is invalid');</script>"; 
}
}
              ...
              <div class="auth-form-light text-left p-5">
                ...
                <form class="pt-3" id="login" method="post" name="login">
                  <div class="form-group">
                    <input type="email" class="form-control form-control-lg" placeholder="LectureEmail Address" required="true" name="email">
                  </div>
                  <div class="form-group">
                    
                     <input type="text" class="form-control form-control-lg"  name="mobile" placeholder="ContactNumber Number" required="true" maxlength="10" pattern="[0-9]+">
                  </div>
                  <div class="form-group">
